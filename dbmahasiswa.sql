...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2025 at 05:39 AM
...
INSERT INTO `tdosen` (`KdDosen`, `NamaDosen`, `kdMatKul`) VALUES
('d0000', 'sdf', 'MK001'),
('d0007', 'sdf', 'MK001'),
('D001', 'DARTO', 'MK007'),
('D002', 'HERIS P', 'MK006'),
...
CREATE TABLE `tmahasiswa` (
  ...
  `TahunLulusSMA` smallint(6) DEFAULT NULL,
...
('07830072', 'BUDI IBRAHIM', 'LAKI-LAKI', '1998-10-07', 'JL IR RAIS IX/406', 'BLITAR', 'JL IR RAIS IX/406', 'Islam', 2007, 'REGULAR', NULL, '3B', '07830072'),
...
('09248tes', 'TESJUGA', 'PEREMPUAN', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ''),
('11111', 'textbox', 'LAKI-LAKI', '1986-09-30', 'RichTextBox', 'textbox', 'RichTextBox', 'ISLAM', 0, 'REGULAR', 'textbox', '3A', '11111'),
('239932', 'SUSIANA', NULL, NULL, NULL, 'SANGATTA', NULL, NULL, NULL, NULL, NULL, NULL, ''),
...
('911111', 'bbbb', NULL, NULL, NULL, 'malang', NULL, NULL, NULL, NULL, NULL, NULL, ''),
('98888', 'Tes Budianto', NULL, NULL, NULL, 'SANGATTA', NULL, NULL, NULL, NULL, NULL, NULL, ''),
...
INSERT INTO `tnilai` (`NIM`, `kdmatakuliah`, `QUIZ`, `UTS`, `UAS`) VALUES
...
ALTER TABLE `tdosen`
  ...
  ADD KEY `TMataKuliahTDosen` (`kdMatKul`);
...
--
ALTER TABLE `tnilai`
  ADD PRIMARY KEY (`NIM`,`kdmatakuliah`),
  ADD KEY `TMahasiswaTNilai` (`NIM`),
  ADD KEY `TMataKuliahTNilai` (`kdmatakuliah`);
...
--
ALTER TABLE `tdosen`
  ADD CONSTRAINT `TDosen_MataKuliah_TMataKuliah_KdMataKuliah` FOREIGN KEY (`kdMatKul`) REFERENCES `tmatakuliah` (`KdMataKuliah`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tnilai`
  ADD CONSTRAINT `TNilai_MATAKULIAH_TMataKuliah_KdMataKuliah` FOREIGN KEY (`kdmatakuliah`) REFERENCES `tmatakuliah` (`KdMataKuliah`) ON DELETE CASCADE ON UPDATE CASCADE,
